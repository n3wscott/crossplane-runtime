...
// A IControllerEngine can start and stop Kubernetes controllers on demand.
//
//nolint:interfacebloat // We use this interface to stub the engine for testing, and we need all of its functionality.
type IControllerEngine interface {
	Start(name string, o ...ControllerOption) error
	Stop(ctx context.Context, name string) error
	IsRunning(name string) bool
	GetWatches(name string) ([]WatchID, error)
	StartWatches(ctx context.Context, name string, ws ...Watch) error
	StopWatches(ctx context.Context, name string, ws ...WatchID) (int, error)
...
// Start does nothing.
func (e *NopEngine) Start(_ string, _ ...ControllerOption) error {
	return nil
}
...
func (e *NopEngine) GetWatches(_ string) ([]WatchID, error) { return nil, nil }

// StartWatches does nothing.
func (e *NopEngine) StartWatches(_ context.Context, _ string, _ ...Watch) error { return nil }

// StopWatches does nothing.
func (e *NopEngine) StopWatches(_ context.Context, _ string, _ ...WatchID) (int, error) {
	return 0, nil
}
