...
// A CompositeResourceDeleter creates a managed, and controls the policy
// used to delete the managed.
...
// A CompositeResourceReferencer can reference a managed resource.
