...
// A CompositeDeletePolicy determines how the managed resource should be deleted
...
const (
	// CompositeDeleteBackground means the managed resource will be deleted using
	// the Background Propagation Policy when the claim is deleted.
	CompositeDeleteBackground CompositeDeletePolicy = "Background"

	// CompositeDeleteForeground means the managed resource will be deleted using
